...
{
    public class IncrementVersionByWithGitIntegrationHandlerTests
    {
        ...
        {
            // Arrange
            var request = new IncrementVersionByWithGitIntegrationCommand
            {
                GitDirectory = "C:\\Temp",
            ...
            var logger = new NullLogger< IncrementVersionByWithGitIntegrationHandler>();
            ...
            var sut = new IncrementVersionByWithGitIntegrationHandler(mediator.Object, gitService.Object, assemblyVersioningService.Object, logger);

            // Act
            await sut.Handle(new IncrementVersionByWithGitIntegrationCommand(), CancellationToken.None);

            // Assert
            mediator.Verify(x => x.Send(It.IsAny<GetVersionIncrementQuery>(), CancellationToken.None), Times.Never);
        ...
        public async Task Handler_ExitsWhen_IncrementIsUnknown()
        {
            ...
            var request = new IncrementVersionByWithGitIntegrationCommand
            {
                ...
                BranchName = "test",
                RemoteTarget = "origin",
                Increment = VersionIncrement.Unknown
            };
            var mediator = new Mock<IMediator>();
            var gitService = new Mock<IGitService>();
            var assemblyVersioningService = new Mock<IAssemblyVersioningService>();
