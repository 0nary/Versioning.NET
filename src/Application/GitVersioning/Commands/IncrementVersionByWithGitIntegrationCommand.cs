...
namespace Application.GitVersioning.Commands
{
    ...
    /// </summary>
    public class IncrementVersionByWithGitIntegrationCommand : IRequest<Unit>
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="VersionIncrement"/> to appli.
        /// </summary>
        public VersionIncrement Increment { get; set; } = VersionIncrement.Unknown;
    }
}
